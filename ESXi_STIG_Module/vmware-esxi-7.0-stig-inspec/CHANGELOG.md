...
CHANGES (2022-11-30)
- ESXI-70-000007 Added -Remove duplicate Get-AdvancedSetting -Name from command and change to Match
- ESXI-70-000008 Added -Remove duplicate Get-AdvancedSetting -Name from command 